...
class LTAE(nn.Module):
    def __init__(self, in_channels=1, n_head=16, d_k=8, n_neurons=[256,128], dropout=0.2, d_model=256,
                 T=1000, len_max_seq=48, positions=None, return_att=False):
        """
        ...
        self.final_layer = nn.Linear(n_neurons[-1],1)
    ...
    def forward(self, x):
        ...
        enc_output = self.final_layer(enc_output)
        if self.return_att:
